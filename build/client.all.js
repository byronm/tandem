/*! Tandem Realtime Coauthoring Engine - v0.11.5 - 2013-12-13
 *  https://www.stypi.com/
 *  Copyright (c) 2013
...
},{"./diff_match_patch":2,"./insert":3,"./op":4,"./retain":5}],2:[function(require,module,exports){
(function() {
  var googlediff;
...
},{"googlediff":7}],3:[function(require,module,exports){
(function() {
  var InsertOp, Op,
...
},{"./op":4}],6:[function(require,module,exports){
module.exports = require('./build/delta.js')

},{"./build/delta.js":1}],7:[function(require,module,exports){
module.exports = require('./javascript/diff_match_patch_uncompressed.js').diff_match_patch;

},{"./javascript/diff_match_patch_uncompressed.js":8}],8:[function(require,module,exports){
/**
...
},{"tandem-core/delta":6}],10:[function(require,module,exports){
...
initEngineListeners = function() {
  ...
  return this.engine.on(TandemEngine.events.UPDATE, function(delta) {
    ...
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    _this.emit.apply(_this, [TandemFile.events.ERROR, _this].concat(__slice.call(args)));
    warn.apply(null, ["Engine error, attempting resync", _this.id].concat(__slice.call(args)));
    return resync.call(_this);
  });
};
...
},{"./engine":9,"./network":11,"tandem-core/delta":6}],11:[function(require,module,exports){
